...
from PyCMD.system import System, LinearGuidanceRel, SphericalJointRel_Tait_Bryan, RigidBodyRel, Force
...
if __name__ == '__main__':
    ...
    rev_joint = SphericalJointRel_Tait_Bryan(q0=[0, 0, alpha0], u0=[0, 0, alpha_dot0])
