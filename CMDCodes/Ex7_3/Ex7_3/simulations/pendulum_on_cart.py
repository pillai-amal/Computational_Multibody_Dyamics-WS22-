...
from PyCMD.system import System, LinearGuidanceRel, RevoluteJointRelActuated, RigidBodyRel, Force, TwoPointInteraction
from PyCMD.system import LinearSpring, LinearDamper, LinearSpringDamper
from PyCMD.solver import TrapezoidalImplicit, EulerExplicit
...
if __name__ == '__main__':
    ...
    tau = lambda t: 0.25 * np.sin(2 * t)
    rev_joint = RevoluteJointRelActuated(tau=tau, q0=alpha0, u0=alpha_dot0)
    ...
    # g0 = 1
    # c = 1
    # spring = TwoPointInteraction(LinearSpringDamper(k, c, g0), pole_on_cart_system.origin, cart)
    # pole_on_cart_system.add(spring)
